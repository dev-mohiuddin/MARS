...
const maintenanceCosts = [
  ...
  },
  {
    ...
    description:
      'Complete overhaul of the engine for performance optimization.',
    costAmount: 5000, 
    date: '2024-06-05',
    duration: '12 hours',
    ...
    <Table className="min-w-max">
      ...
      <TableHeader>
        <TableRow>
          ...
          <TableHead className='text-right'>Cost Amount (USD)</TableHead>
      ...
      <TableBody>
        {maintenanceCosts.map((cost, index) => (
          <TableRow key={index}>
            ...
            <TableCell className='text-right'>${cost.costAmount}</TableCell>
